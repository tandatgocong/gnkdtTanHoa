...
<%@ Register TagPrefix="aspxx" Namespace="Saplin.Controls" Assembly="DropDownCheckBoxes" %>
...
<table border="1" style="margin-top:10px;">
    ...
    <td><div>
        <aspxx:DropDownCheckBoxes ID="DropDownDMA" runat="server" Font-Size="13"> 
         <Style SelectBoxWidth="145" DropDownBoxBoxWidth="150" DropDownBoxBoxHeight="150"/>
        </aspxx:DropDownCheckBoxes> 
        </div>
    </td>
     </tr>
